...
export default function ContactSection() {
  ...
  try {
    const res = await fetch("https://vb-6enm.onrender.com/contact", {
      method: "POST",
      headers: {
  ...
  return (
    <section className="w-full py-10 px-20 lg:px-16 flex flex-col lg:flex-row items-center justify-between">
      {/* Left Side - Form */}
