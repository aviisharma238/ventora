...
function Hero() {
  ...
  return (
    <section
      className="bg-black relative px-6 py-52 lg:px-16 min-h-[100vh] flex flex-col items-center justify-center text-center overflow-hidden text-white"
      style={{
        backgroundColor: "#0f0f0f",
        backgroundImage: `
          linear-gradient(to right, rgba(255, 255, 255, 0.03) 1px, transparent 1px),
          linear-gradient(to bottom, rgba(255, 255, 255, 0.03) 1px, transparent 1px),
          radial-gradient(at bottom right, rgba(88, 99, 250, 0.25), transparent 50%)
        `,
    ...
    >
      ...
      <div className="max-w-4xl w-full flex flex-col items-center justify-center gap-6 z-10">
        <h1 className="text-center font-extrabold leading-relaxed tracking-tight text-3xl sm:text-3xl md:text-4xl lg:text-5xl">
          <div className="mb-3">
